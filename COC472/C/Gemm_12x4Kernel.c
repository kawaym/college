		...
		double *C, int ldC )
{
  ...
  __m256d gamma_8901_0 = _mm256_loadu_pd( &gamma( 8,0 ) );

  __m256d gamma_0123_1 = _mm256_loadu_pd( &gamma( 0,1 ) );
  __m256d gamma_4567_1 = _mm256_loadu_pd( &gamma( 4,1 ) );
  __m256d gamma_8901_1 = _mm256_loadu_pd( &gamma( 8,1 ) );

  __m256d gamma_0123_2 = _mm256_loadu_pd( &gamma( 0,2 ) );
  __m256d gamma_4567_2 = _mm256_loadu_pd( &gamma( 4,2 ) );
  __m256d gamma_8901_2 = _mm256_loadu_pd( &gamma( 8,2 ) );

  __m256d gamma_0123_3 = _mm256_loadu_pd( &gamma( 0,3 ) );
  __m256d gamma_4567_3 = _mm256_loadu_pd( &gamma( 4,3 ) );
  __m256d gamma_8901_3 = _mm256_loadu_pd( &gamma( 8,3 ) );
  ...
  for ( int p=0; p<k; p++ ){
    ...
    __m256d alpha_8901_p = _mm256_loadu_pd( &alpha( 8,p ) );
    ...
    gamma_8901_0 = _mm256_fmadd_pd( alpha_8901_p, beta_p_j, gamma_8901_0 );
    ...
    gamma_8901_1 = _mm256_fmadd_pd( alpha_8901_p, beta_p_j, gamma_8901_1 );
    ...
    gamma_8901_2 = _mm256_fmadd_pd( alpha_8901_p, beta_p_j, gamma_8901_2 );
    ...
    gamma_8901_3 = _mm256_fmadd_pd( alpha_8901_p, beta_p_j, gamma_8901_3 );
  }
  
  /* Store the updated results */
  _mm256_storeu_pd( &gamma(0,0), gamma_0123_0 );
  _mm256_storeu_pd( &gamma(4,0), gamma_4567_0 );
  _mm256_storeu_pd( &gamma(8,0), gamma_8901_0 );

  _mm256_storeu_pd( &gamma(0,1), gamma_0123_1 );
  _mm256_storeu_pd( &gamma(4,1), gamma_4567_1 );
  _mm256_storeu_pd( &gamma(8,1), gamma_8901_1 );

  _mm256_storeu_pd( &gamma(0,2), gamma_0123_2 );
  _mm256_storeu_pd( &gamma(4,2), gamma_4567_2 );
  _mm256_storeu_pd( &gamma(8,2), gamma_8901_2 );

  _mm256_storeu_pd( &gamma(0,3), gamma_0123_3 );
  _mm256_storeu_pd( &gamma(4,3), gamma_4567_3 );
  _mm256_storeu_pd( &gamma(8,3), gamma_8901_3 );
}
