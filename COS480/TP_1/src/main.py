...
from fixed_heap_sql import insert_one, insert_many, delete_one, delete_many_by_field, select_one, select_many_by_array, select_many_by_interval, select_many_by_field
...
delete_one("001", file_path)
delete_many_by_field("Punimon", file_path)
